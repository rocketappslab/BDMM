...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--niter', type=int, default=25000, help='# of iter with initial learning rate')
        parser.add_argument('--niter_decay', type=int, default=25000, help='# of iter to decay learning rate to zero')

        # learning rate and loss weight
        parser.add_argument('--lr_policy', type=str, default='lambda', help='learning rate policy[lambda|step|plateau]')
        parser.add_argument('--lr', type=float, default=1e-4, help='initial learning rate for adam')
        parser.add_argument('--gan_mode', type=str, default='lsgan', choices=['wgan-gp', 'hinge', 'lsgan', 'softplus'])
        ...
        parser.add_argument('--save_iters_freq', type=int, default=1000000, help='frequency of saving checkpoints at the end of epochs')
